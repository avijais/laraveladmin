            ...
            <div class="box">
            	...
            	<div class="box-body">
            		<div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            			<!-- SEARCH PANNEL & SELECT NO OF PAGE -->
                        <!-- <div class="row">
	            			<div class="col-sm-6">
            			...
            			<div class="row">
            				<div class="col-sm-12">
            					<table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                					<thead>
                						<tr role="row">
                							<th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 167px;">Rendering engine</th>
                							...
                							<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 182px;">Platform(s)</th>
                        ...
                        <!-- SHOW PAGINATION NO. WITH CURRENT PAGE NO. -->
                        <!-- <div class="row">
                        	<div class="col-sm-5">
...
<script type="text/javascript" src="{{ url('app/js/admin/user_list.js')}}"></script>